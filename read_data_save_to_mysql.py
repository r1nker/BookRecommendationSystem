...
User = pd.read_csv(path, sep=None, on_bad_lines='skip',engine='python')
...
Book = pd.read_csv(path, sep=None, on_bad_lines='skip',engine='python')
...
Rating = pd.read_csv(path, sep=None, on_bad_lines='skip',engine='python')
